<?php
  ...
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryCategories.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryProducts.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryNews.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryContacts.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryUsers.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryIntros.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryPictures.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryOrders.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryRatings.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryPageings.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/library/libraryFiles.php';

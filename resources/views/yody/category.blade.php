    ...
    <div class="container">
        ...
        <div class="list-cate">
            <div class="swiper-main swiper-container-initialized swiper-container-horizontal swiper-container-multirow" style="cursor: grab;">
                <div class="swiper-wrapper" id="swiper-wrapper-8553d68f47ceba1e" aria-live="polite" style="width: 1565px; transform: translate3d(0px, 0px, 0px);">
                    @foreach ($arrMenu as $category)
                    @if ($arrCat->cat_id == $category->cat_id)
                        ...
                        @if ($category->cat_id == $classify->parent_id)
                            ...
                            @if ($classify->cat_id == $classifyGroup->parent_id && $classifyGroup->active == 1)
                                @php
                                    ...
                                    $urlPicture = 'storage/templates/yody/images/'.$classifyGroup->picture_menu;
                                @endphp
                                <div class="swiper-slide item swiper-slide-active" role="group" aria-label="1 / 10" style="order: 0; width: 298px; margin-right: 15px;">
                                    <a href="{{$urlGroup}}">
                                        <img src="{{$urlPicture}}">
                                        <span>{{$classifyGroup->sub_name}}</span>
                                    </a>
                                </div>
                            @endif
                            @endforeach
...
<div class="section_services">
    ...
    <div class="section_banner" style="background: white;margin-bottom: 0;">
        <div class="container" style="padding: 0">
        <h2 class="title-block">
            MUA THEO PHONG CÁCH
        </h2>
        <div class="list">
            <a href="/thoi-trang-thu-dong-nu" class="banner banner-1">
                <picture>
                    <source media="(min-width: 1200px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_1.jpg?1675503263054">
                    <source media="(min-width: 768px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_1.jpg?1675503263054">
                    <source media="(min-width: 569px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_1_mb.jpg?1675503263054">
                    <source media="(max-width: 480px)" srcset="//bizweb.dktcdn.net/thumb/grande/100/438/408/themes/893280/assets/page_nu_banner_1_mb.jpg?1675503263054">
                    <img src="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_1.jpg?1675503263054" alt="Ấm áp với trang phục thu đông" class="img-responsive center-block">
                </picture>
            </a>
            <a href="/thoi-trang-cong-so-nu" class="banner banner-2">
                <picture>
                    <source media="(min-width: 1200px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_2.jpg?1675503263054">
                    <source media="(min-width: 768px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_2.jpg?1675503263054">
                    <source media="(min-width: 569px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_2_mb.jpg?1675503263054">
                    <source media="(max-width: 480px)" srcset="//bizweb.dktcdn.net/thumb/grande/100/438/408/themes/893280/assets/page_nu_banner_2_mb.jpg?1675503263054">
                    <img src="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_2.jpg?1675503263054" alt="Thanh lịch với thời trang công sở" class="img-responsive center-block">
                </picture>
            </a>
            <a href="/thoi-trang-basic-nu" class="banner banner-3">
                <picture>
                    <source media="(min-width: 1200px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_3.jpg?1675503263054">
                    <source media="(min-width: 768px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_3.jpg?1675503263054">
                    <source media="(min-width: 569px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_3_mb.jpg?1675503263054">
                    <source media="(max-width: 480px)" srcset="//bizweb.dktcdn.net/thumb/grande/100/438/408/themes/893280/assets/page_nu_banner_3_mb.jpg?1675503263054">
                    <img src="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_3.jpg?1675503263054" alt="Cuốn hút với phong cách basic" class="img-responsive center-block">
                </picture>
            </a>
            <a href="/phong-cach-the-thao-nu" class="banner banner-4">
                <picture>
                    <source media="(min-width: 1200px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_4.jpg?1675503263054">
                    <source media="(min-width: 768px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_4.jpg?1675503263054">
                    <source media="(min-width: 569px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_4_mb.jpg?1675503263054">
                    <source media="(max-width: 480px)" srcset="//bizweb.dktcdn.net/thumb/grande/100/438/408/themes/893280/assets/page_nu_banner_4_mb.jpg?1675503263054">
                    <img src="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_4.jpg?1675503263054" alt="Năng động, khỏe khoắn cùng YODY SPORT" class="img-responsive center-block">
                </picture>
            </a>
            <a href="https://yody.vn/blog-thoi-trang-nu" class="banner banner-5">
                <picture>
                    <source media="(min-width: 1200px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_5.jpg?1675503263054">
                    <source media="(min-width: 768px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_5.jpg?1675503263054">
                    <source media="(min-width: 569px)" srcset="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_5_mb.jpg?1675503263054">
                    <source media="(max-width: 480px)" srcset="//bizweb.dktcdn.net/thumb/grande/100/438/408/themes/893280/assets/page_nu_banner_5_mb.jpg?1675503263054">
                    <img src="//bizweb.dktcdn.net/100/438/408/themes/893280/assets/page_nu_banner_5.jpg?1675503263054" alt="Tips phối đồ cực xinh" class="img-responsive center-block">
                </picture>
            </a>
        </div>
        </div>
...
<section class="section-product section-product-tab ajax-product" style="margin-top: -40px">
                    ...
                    <div class="container">
                        <div class="tabs-title-ajax">
                            ...
                            <div class="title-desktop" >
                                <ul class="tabs tabs-title ajax" style="background: white; margin-bottom: 40px">
                                    @foreach ($arrCats as $item)
                                        @php
                                            $slug = Str::slug($item->name);
                                            $urlClassify = route('yody.classify', ['slug' => $slug, 'id' => $item->cat_id]);
                                        @endphp
                                        <li class="tab-link has-content"><a style="color: #000" href="{{$urlClassify}}">{{$item->name}}</a> </li>
                                    @endforeach
                                    ...
                                    @if ($category->cat_id == $classify->parent_id)
                                        ...
                                        @if ($classify->cat_id == $classifyGroup->parent_id)
                                            @foreach ($arrProducts as $product)
                                                @if ($product->cat_id == $classifyGroup->cat_id)
                                                    @php
